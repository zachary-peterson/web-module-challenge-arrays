...
console.log(copy(originalFlavors, "ogFlav"));
...
var theOriginalFlavors = ["Banana Nut Fudge",
    "Black Walnut",
    "Burgundy Cherry",
   "Butterscotch Ribbon",
    "Cherry Macaron",
...
function getAverageWordLength(arr){
    ...
    avgWords = Math.round(arr.length/avgWords);
    return avgWords;
}

console.log(getAverageWordLength(theOriginalFlavors));
...
function getRandomFlavors(arrOne, arrTwo, arrThree, arrFour){
    ...
    for(let i = 0; randomFlavors.length < 31; i++){
        randomFlavors.push(allFlavors[i]);
    }
    return randomFlavors;
}
console.log(getRandomFlavors(newFlavors, theOriginalFlavors, seasonalFlavors, regionalFlavors));